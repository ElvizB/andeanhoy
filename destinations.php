            ...
            <div class="row text-center">
                ...
                <div class="col-md-6 mb-md-0 mb-3">
                    ...
                    <div class="testimonial pt-5">
                        ...
                        <p class="white-text text-justify wow fadeInUp" data-wow-delay="0.4s">
                            Welcome to Peru. In our country you will find a great diversity of climates, cultures,
                            experiences and gastronomy that you will not be able to forget. We invite you to tour our
                            country with the help of the programs we have developed for you.
                        </p>
                        <!--Review-->
                    </div>
                ...
                <div class="col-md-2 mb-md-0 mb-3">
                    ...
                    <div class="testimonial text-justify white-text wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <div class="mb-2">
                            <span class="lang font-weight-bold" key="d_area_geo">GEOGRAPHIC AREA</span>
                            <br>
                            <!-- Section description -->
                        ...
                        <div>
                            ...
                            <br>
                            <!-- Section description -->
                            <span class="class w-responsive mx-auto">32 510 600 inhabitants</span>
                ...
                <div class="col-md-2">
                    ...
                    <div class="testimonial text-justify white-text wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <div class="mb-2">
                            <span class="font-weight-bold">OFFICIAL LANGUAGE</span>
                            <br>
                            <!-- Section description -->
                        ...
                        <div>
                            <span class="font-weight-bold">AIRPORT</span>
                            <br>
                            <!-- Section description -->
                ...
                <div class="content2">
                    <div class="">
                        <p class="title-descriptions-map wow fadeInUp " data-wow-delay="0.1s">
                            Hover over the image of the destination to know its location on the map.
                        </p>
                    </div>
