    ...
    <div class="carousel-inner z-depth-2" role="listbox">
            ...
            <div class="content-info-slider">
                <div class="u-content-house">
                    <p class="primary-title-home">
                        Disfruta la magia y encantos de MachuPicchu
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="carousel-item banner_dos view">
            <div class="content-info-slider">
                <div class="u-content-house">
                    <p class="primary-title-home">
                        Conéctate con la naturaleza que ofrece la selva peruana
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="carousel-item banner_tres view">
            <div class="content-info-slider">
                <div class="u-content-house">
                    <p class="primary-title-home">
                        Experimenta los mejores panoramas que te ofrecen los Treks Andinos
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="carousel-item banner_cuatro view">
            <div class="content-info-slider">
                <div class="u-content-house">
                    <p class="primary-title-home">
                        Conoce uno de los cañones más profundos del mundo y a su guardián, el Cóndor
                    </p>
                </div>
            </div>
        </div>
